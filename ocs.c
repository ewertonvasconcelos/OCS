...
fonteDiodo(double Is, double nVt, int a, int b)
{
	...
	if (v0 >= D_VMAX)
		...
		i0 = (Is * (exp(v0 / nVt) - 1)) - ((Is * exp(v0 / nVt) / nVt) * v0);
...
void transistor(double Isbe, double nVtbe, double Isbc, double nVtbc, double al, double al_r,
